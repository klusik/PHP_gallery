...
This document describes the database schema used by PHP Gallery as of application version 0.91.1. The source of truth remains the migration files in `database/migrations/`, but this file summarizes the final model and the purpose of each table.
