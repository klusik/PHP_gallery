...
\newcommand{\version}{0.88}
\newcommand{\manualdate}{12 August 2026}
...
\subsection{What is new in Version 0.88}
\index{Version 0.88}

Version~0.88 makes a large installation easier to configure, deploy, and maintain. The central \ui{Settings} page now includes a Spotlight-style search over global settings and specialist tools. Theme controls include dedicated public tag-page presentation and configurable gallery hero tags. Dashboard maintenance data is loaded only when requested, with direct thumbnail-maintenance links and diagnostic Admin logs when loading fails.
