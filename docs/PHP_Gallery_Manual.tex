...
\subsection{What is~new in~Version 0.91.3}
\index{Version 0.91.3}

Version~0.91.3 consolidates the~complete Version~0.91, 0.91.1, and~0.91.2 viewer and~Smart Gallery improvements and~stabilizes slideshow preloading and~fullscreen transitions. The~slideshow prepares the~next authorized photograph without disturbing the~active transition, rejects duplicate or~stale preload work, and~keeps timing, navigation, controls, and~loading state synchronized when fullscreen changes.
