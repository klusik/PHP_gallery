...
PHP Gallery treats the language of the program interface separately from the text that you write yourself. Changing the interface language changes buttons, menu items, help text, status messages, dialogs, and other application wording. It does \emph{not} automatically translate gallery titles, gallery descriptions, photo descriptions, tags, or other content entered by the gallery owner.
