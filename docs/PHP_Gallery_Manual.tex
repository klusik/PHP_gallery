...
These choices do not have to match. For example, an administrator may work in Czech while the public gallery uses English, Swedish, or German. A public visitor can also request one of the same four supported languages with an address parameter such as \codeword{?lang=sv}; PHP Gallery remembers that visitor choice in the browser.
