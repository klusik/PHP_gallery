...
\subsection{What is new in Version 0.89}
\index{Version 0.89}

Version~0.89 makes a large installation easier to configure, deploy, and maintain. The central \ui{Settings} page includes a Spotlight-style search over global settings and specialist tools, while Theme~>~Language provides a compact, validated design editor for the public viewer language selector. Administrators can choose five presets, toggle flags/codes/names, use transparent colors, preview the real selector immediately, and reset individual values, a preset, or the complete design without saving until the parent form is submitted.
