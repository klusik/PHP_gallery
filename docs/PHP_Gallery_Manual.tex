...
\newcommand{\version}{0.106.1}
\newcommand{\manualdate}{20 September 2026}
...
Moving photographs between galleries uses a~durable operation journal. If~a~worker or~connection stops partway through, System Health and~Runtime Diagnostics show a~bounded action state without exposing private paths. Stop competing storage work, preserve a~backup, and~follow \filepath{docs/IMAGE_MOVE_RECOVERY.md}; recovery retains changed or~unverifiable files instead of~overwriting them.
