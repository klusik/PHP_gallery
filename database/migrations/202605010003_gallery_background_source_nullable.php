 ...
 *
 * File: database/migrations/202605010003_gallery_background_source_nullable.php
...
return [
    "ALTER TABLE galleries MODIFY COLUMN background_source ENUM('upload','existing','collage') NULL DEFAULT NULL",
];
