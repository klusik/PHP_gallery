 ...
 *
 * File: database/migrations/202605010001_gallery_thumbnail_path.php
...
return [
    "ALTER TABLE galleries ADD COLUMN cover_image_path VARCHAR(1024) NULL AFTER cover_image_id",
];
