...
smart_gallery_high_priority_assert(
    ...
    && str_contains($galleryJs, 'admin-operations.js?v=20260912-card-visibility-eye-v1')
    && str_contains($adminOperations, 'admin-side-panel.js?v=20260912-card-visibility-eye-v1')
