...
leaflet_marker_assert_contains($galleryEntrypoint, '20260920-lightbox-preload-lifecycle-v1', 'authenticated entrypoint cache revision');
leaflet_marker_assert_contains($publicEntrypoint, '20260920-lightbox-preload-lifecycle-v1', 'public entrypoint cache revision');
