...
leaflet_marker_assert_contains($galleryEntrypoint, '20260919-lightbox-navigation-transaction-v1', 'authenticated entrypoint cache revision');
leaflet_marker_assert_contains($publicEntrypoint, '20260919-lightbox-navigation-transaction-v1', 'public entrypoint cache revision');
