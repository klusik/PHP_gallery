...
lightbox_zoom_integration_assert(
    str_contains($publicEntrypointSource, 'lightbox-deferred.js?v=20260817-lightbox-zoom-centered-frame-v12')
        && str_contains($authenticatedEntrypointSource, 'lightbox-deferred.js?v=20260817-lightbox-zoom-centered-frame-v12'),
