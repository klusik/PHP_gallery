...
stage4_expect(str_contains($operations, 'admin-side-panel.js?v=20260920-lightbox-preload-lifecycle-v1'), 'Admin operations must load the current side-panel cache version.');
$galleryJs = stage4_source('public/assets/gallery.js');
stage4_expect(str_contains($galleryJs, 'admin-operations.js?v=20260920-lightbox-preload-lifecycle-v1'), 'Gallery entrypoint must load the current admin-operations cache version.');
