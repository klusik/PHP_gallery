...
function cms_run(): void
{
    ...
    $routes = [
        ...
        'admin_upload_settings' => 'cms_admin_upload_settings',
        'admin_upload_experimental_batch' => 'cms_admin_upload_experimental_batch',
        ...
        'admin_check_thumbnail_maintenance' => 'cms_admin_check_thumbnail_maintenance',
        'admin_create_thumbnails' => 'cms_admin_create_thumbnails',
        'admin_thumbnail_experimental_source_chunk' => 'cms_admin_thumbnail_experimental_source_chunk',
        'admin_thumbnail_experimental_upload_batch' => 'cms_admin_thumbnail_experimental_upload_batch',
