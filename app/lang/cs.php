...
return [
    ...
    'admin.updates.autoupdate_next_check_label' => 'Další automatická kontrola',
    'admin.updates.github_api_http_status' => 'Poslední HTTP stav',
    'admin.updates.github_api_last_url' => 'Poslední endpoint',
    'admin.updates.github_api_secondary_backoff' => 'Backoff sekundárního limitu',
    'admin.updates.github_api_secondary_backoff_value' => '{seconds} sekund',
    'admin.updates.github_cache_value' => '{time}, expiruje {expires}',
    'admin.updates.github_metadata_cache' => 'Cache metadat aktualizací',
    'admin.updates.github_passive_page_hint' => 'Opětovné načtení této stránky používá pouze místní cache. GitHub nekontaktuje, pokud nepoužijete vynucenou kontrolu nebo nenastane čas automatické kontroly.',
    'admin.updates.github_patch_notes_cache' => 'Cache patch notes',
];
