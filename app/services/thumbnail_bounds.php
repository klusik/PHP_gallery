...
function render_admin_thumbnail_bound_slider(string $prefix, ?int $storedMinSize, ?int $storedMaxSize, string $label, string $description): void
{
    ...
    echo '<span><small>Min</small><b data-thumbnail-bound-min-display>Auto min</b></span>';
    echo '<span><small>Max</small><b data-thumbnail-bound-max-display>Auto max</b></span>';
    echo '</div>';
