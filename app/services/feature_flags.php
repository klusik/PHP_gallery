...
function feature_flag_route_map(): array
{
    return [
        ...
        'download_gallery_start' => 'downloads',
        'download_gallery' => 'downloads',
        'download_gallery_manifest' => 'downloads',
        'download_gallery_file' => 'downloads',
        'download_smart_gallery_start' => 'downloads',
        'download_smart_gallery' => 'downloads',
        'download_smart_gallery_manifest' => 'downloads',
        'download_smart_gallery_file' => 'downloads',
