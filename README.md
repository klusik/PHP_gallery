...
Version 0.95.4 restores and hardens the focused download and Smart Gallery regression contracts. Isolated test fixtures now provide the runtime and request helpers required by the production services, browser download activation remains documented and checked, and download capability construction is covered by function documentation. No database migration or configuration change is required.
