...
Version 0.91.1 is a focused lightbox navigation refinement on top of Version 0.91. It adds a documented Shift+Left/Right shortcut for moving ten photographs at a time, keeps ordinary arrows for single-photo movement, and retains the existing zoom, progressive image quality, access-control, fullscreen, map, and no-JavaScript behavior.
